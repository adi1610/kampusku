...
$dosen = $db->query("SELECT * FROM dosen where id_user = $id_user ");
$data_dosen = $dosen->fetch_assoc();
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="#"><i class="icon-cog5"></i>settings</a></li>
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            <div class="panel panel-body login-form" style="opacity: 0.9;">
                                                ...
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="hidden" class="form-control" placeholder="idlogin" id="idlogin" name="idlogin" readonly=1 value="<?php echo $_SESSION['idlogin']?>">
                                                    <input type="hidden" class="form-control" placeholder="username" id="username" name="username" readonly=1 value="<?php echo $_SESSION['username']?>">
                                                ...
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control" placeholder="Nama" id="nama" name="nama" value="<?php echo !empty($data_dosen['nama'])? $data_dosen['nama'] : '' ?>">
                                                </div>

                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control" placeholder="Nip" id="nip" name="nip" value="<?php echo !empty($data_dosen['nip'])? $data_dosen['nip'] : '' ?>">
                                                </div>

                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="file" class="form-control" placeholder="Gambar" id="gambar" name="gambar" value="<?php echo !empty($data_dosen['gambar'])? $data_dosen['gambar'] : '' ?>">
                                                </div>

                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control" placeholder="Email" id="email" name="email" value="<?php echo !empty($data_dosen['email'])? $data_dosen['email'] : '' ?>">
                                                </div>

                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary btn-block" name="updateuser" value="updateuser">Update <i class="icon-circle-right2 position-right"></i></button>
                                                </div>

                                                <div>
                                                    <a href="home.php"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-arrow-left"></i> Kembali</button></a>
                                                </div>
